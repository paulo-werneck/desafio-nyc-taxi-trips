-------------------------------------------------------
-- Descricao: Script para criacao da tabela de viagens de taxi em Nova York
    -- na área de "landing zone" do data lake
-- Autor: Paulo Werneck
-- Data: 05-11-2020
-------------------------------------------------------

CREATE EXTERNAL TABLE lz_nyc_taxi_trips.tb_taxi_trips
(
  vendor_id           string COMMENT 'id da empresa de taxi',
  pickup_datetime     string COMMENT 'data e hora de inicio da corrida',
  dropoff_datetime    string COMMENT 'data e hora de termino da corrido',
